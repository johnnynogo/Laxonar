...
const float threshold = 25.0;  // RMS threshold for 0.1V peak
...
const int sender1 = 4;  // Sender pin, ytterst venstre
const int sender2 = 5;  // Sender pin, midten
// const int sender3 = 8; // Sender pin, ytterst høyre
const int receiver = 6;  // Mottakker pin
...
void loop() {
  ...
  if (Vrms > threshold) {
    Serial.println("Peak voltage above threshold detected!");
  }
}